...
MODEL_PATH = os.path.join(BASE_DIR, "model_goodreads.joblib")
...
def main():
    ...
    train_file = "training_goodreads.tsv"
    test_file = "testing_goodreads.tsv"
    negative_file = "negative_samples.tsv"
     
    # Load train ratings
    trainRatings = load_ratings(train_file)
    # Load test ratings
